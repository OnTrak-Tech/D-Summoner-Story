...
export const SummonerInput: React.FC<SummonerInputProps> = ({
  ...
  const [summonerName, setSummonerName] = useState(
    initialSummonerName || preferences.lastSummonerName
  );
  ...
  const handleSummonerNameChange = useCallback(
    ...
    <div className="w-full">
      <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-3">Get Your Year in Review</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500 leading-relaxed">
            We'll analyze your ranked and normal games from the past year to create a beautiful,
            personalized story
          </p>
        </div>
      </div>
